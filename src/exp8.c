...
void test_size(gmp_randstate_t st, int n)
{
	test_rnd(st, n, bits);
	fflush(stdout);
}
...
void usage(int argc, char *argv[])
{
	...
	printf("Then a new computations is performed with %d bits.\n",
		PREC_MIN, PREC_MAX, PREC_SUM);
	printf("\n");
	printf("The error is measured and printed out in CSV with the following format:\n");
	printf("n,bits,err,time,time_gold\n");
	printf("n         : The size of the n-by-n matrix.\n");
	printf("bits      : The number of bits of precision in the second computation.\n");
